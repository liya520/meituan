<template>
    <div class="page-login">
        ...
        <div class="login-panel">
            <div class="banner">
                <img width="480" height="370" alt="美团网" src="//s0.meituan.net/bs/file/?f=fe-sso-fs:build/page/static/banner/www.jpg">
            </div>
            <div class="form">
                ...
                <el-button @click="submit" class="btn-login" type="primary">登录</el-button>
                <p class="reg">
                    <span>还没有账号？</span>
                ...
                <div class="oauth-wrapper">
                    ...
                    <div class="oauth cf">
                        <span class="oauth__link oauth__link--qq third-login-btn" id="J-third-tencent" target="_blank" data-href="/account/connect/tencent"></span>
                        <span class="oauth__link oauth__link--weibo third-login-btn" id="J-third-sina" target="_blank" data-href="/account/connect/sina"></span>
                    </div>
                </div>
            </div>
        </div>
